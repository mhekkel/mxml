...
// 	{
// 		ar &mxml::make_element_nvp("a", a) & mxml::make_element_nvp("b", b) & mxml::make_element_nvp("c", c);
// 	}
// };
...
// 	void serialize(Archive &ar, unsigned long)
// 	{
// 		ar &make_mxml::make_element_nvp("e", m_e);
// 	}
// };
...
// 	CHECK_THROW(doc.serialize("test", e), exception);
...
// 	CHECK_THROW(s8.from_string("128"), std::system_error);
// 	CHECK_THROW(s8.from_string("x"), std::system_error);
// }
...
// 	CHECK_THROW(s8.from_string("256"), std::system_error);
// 	CHECK_THROW(s8.from_string("x"), std::system_error);
// }
...
// // 	xml::document doc;
// // 	CHECK_THROW(doc.serialize("v1", v1), exception);
// // }
...
// // 	v_st_1 v2;
// // 	CHECK_THROW(doc.deserialize("v1", v2), exception);
